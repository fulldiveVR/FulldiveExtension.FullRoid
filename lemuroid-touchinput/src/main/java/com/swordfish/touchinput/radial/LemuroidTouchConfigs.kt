...
object LemuroidTouchConfigs {
    ...
    private val BUTTON_CONFIG_START =
        ButtonConfig(
    ...
    private val BUTTON_CONFIG_SELECT =
        ButtonConfig(
    ...
    private val BUTTON_CONFIG_MENU =
        ButtonConfig(
    ...
    private val BUTTON_CONFIG_CROSS =
        ButtonConfig(
    ...
    private val BUTTON_CONFIG_SQUARE =
        ButtonConfig(
    ...
    private val BUTTON_CONFIG_TRIANGLE =
        ButtonConfig(
    ...
    private val BUTTON_CONFIG_CIRCLE =
        ButtonConfig(
    ...
    private val BUTTON_CONFIG_COIN =
        ButtonConfig(
            id = KeyEvent.KEYCODE_BUTTON_SELECT,
    ...
    private val PRIMARY_DIAL_CROSS =
    ...
    private val PRIMARY_DIAL_CROSS_MERGED =
        PrimaryDialConfig.Cross(
            CrossConfig(
    ...
    private fun getDesmumeRight(theme: RadialGamePadTheme) =
        RadialGamePadConfig(
            theme = theme,
            sockets = 12,
            primaryDial =
    ...
    private fun getMelondsRight(theme: RadialGamePadTheme) =
        RadialGamePadConfig(
            theme = theme,
            sockets = 12,
            primaryDial =
    ...
    private fun buildMenuButtonConfig(
        index: Int,
        theme: RadialGamePadTheme,
    ): SecondaryDialConfig {
